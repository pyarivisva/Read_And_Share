...
/**
 * Class DataDonatur adalah JFrame yang digunakan untuk menampilkan data donatur
 * ke dalam sebuah JTable.
 */
public class DataDonatur extends javax.swing.JFrame {
    ...
    /**
     * Konstruktor untuk kelas DataDonatur.
    ...
    private void getData() {
        ...
        try {
           ...
           while(rs.next()) {
               // Mengambil data dari setiap kolom dalam tabel user
               int donor_id = rs.getInt("user_id");
               ...
               model.addRow(new Object[]{donor_id, fullname, username, telephone, email, address});
           ...
           st.close();
            ...
            Logger.getLogger(DataDonatur.class.getName()).log(Level.SEVERE,null,e);
        }
    } 
    ...
    private void initComponents() {
        ...
        donor_data = new javax.swing.JLabel();
        ...
        donor_data.setFont(new java.awt.Font("Segoe UI Black", 1, 24)); // NOI18N
        donor_data.setForeground(new java.awt.Color(2, 59, 135));
        donor_data.setText("Donor Data");
        panel_kanan.add(donor_data, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 60, -1, -1));
        ...
        information_system.setBorder(javax.swing.BorderFactory.createTitledBorder("Information Sistem"));
        ...
        bt_data_donatur.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(0, 0, 255), new java.awt.Color(0, 255, 255), new java.awt.Color(0, 255, 255), new java.awt.Color(0, 0, 255)));
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel2Layout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(bt_data_donatur, javax.swing.GroupLayout.PREFERRED_SIZE, 185, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        tbl_data.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "DonorID", "Full Name", "Username", "Telephone", "Email", "Address"
            }
        ));
        jScrollPane1.setViewportView(tbl_data);

        panel_kanan.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 130, 640, -1));
    ...
    // Kode ini menampilkan JFrame RejectedBooks (opsional)
    ...
    private javax.swing.JLabel donor_data;

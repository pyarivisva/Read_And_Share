...
/**
 * Class DataBook adalah JFrame yang digunakan untuk menampilkan data buku
 * yang didonasikan ke dalam sebuah JTable.
 */
public class DataBook extends javax.swing.JFrame {
    ...
    /**
     * Konstruktor untuk kelas DataBook.
    ...
    private void getData() {
        // Mendapatkan model dari JTable dan mengatur ulang barisnya
        DefaultTableModel model = (DefaultTableModel) tbl_data.getModel();
        model.setRowCount(0);
        
        try {
            // Membuat query SQL untuk mengambil semua data dari tabel donate_donor
           ...
           while(rs.next()) {
               // Mengambil data dari setiap kolom dalam tabel donate_donor
               ...
               Date bookDate     = rs.getDate("date_arrive");
               Date delivery_date = rs.getDate("delivery_date");
               
               // Menambahkan data ke dalam model JTable
               model.addRow(new Object[]{id_book, id_donor, book_title , author, quantity, bookCategoryStr, bookConditionStr, bookDate, delivery_date});
               
           }
            // Menutup result set dan prepared statement
           rs.close();
           st.close();
        }catch (SQLException e) {
            // Menangani kesalahan SQL dan mencatatnya ke dalam log
            Logger.getLogger(DataBook.class.getName()).log(Level.SEVERE,null,e);
        }
    }
    ...
    private void initComponents() {
        ...
        bt_send_book1 = new javax.swing.JLabel();
        ...
        bt_send_book1.setFont(new java.awt.Font("Segoe UI Black", 1, 18)); // NOI18N
        bt_send_book1.setForeground(new java.awt.Color(2, 59, 135));
        bt_send_book1.setText("Send Book");
        bt_send_book1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                bt_send_book1MouseClicked(evt);
            }
        });
        ...
        bt_data_book.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED, java.awt.Color.blue, java.awt.Color.cyan, java.awt.Color.blue, java.awt.Color.cyan));
        ...
        tbl_data.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "BookID", "DonorID", "Book Title", "Author", "Quantity of Books", "Book Category", "Book Condition", "Input Date", "Delivery Date"
            }
        ));
        jScrollPane1.setViewportView(tbl_data);

        panel_kanan.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 60, 750, 510));

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(panel_kanan, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 1049, Short.MAX_VALUE)
        );
    ...
    private void bt_send_book1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bt_send_book1MouseClicked
        ...
        this.dispose();
    }//GEN-LAST:event_bt_send_book1MouseClicked

    public static void main(String args[]) {
       
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DataBook().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel bt_send_book1;

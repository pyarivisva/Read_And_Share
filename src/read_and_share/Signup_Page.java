        ...
        try {
            ...
            if("".equals(t_username.getText())){ // jika nama lengkap kosong
                ...
                JOptionPane.showMessageDialog(new JFrame(), "Password dan password ulang gagal", "Error",
                    ...
                    query = "INSERT INTO user (username, fullname, address, telephone, email, password)VALUES('"+username+"', '"+fullname+"', '"+address+"', '"+telephone+"', '"+email+"' , '"+password+"')";
                    ...
                    showMessageDialog(null, "Sign Up Berhasil");
